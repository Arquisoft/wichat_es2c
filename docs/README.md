...
The deployment url is: [https://arquisoft.github.io/wichat_es2c/](https://arquisoft.github.io/wichat_es2c/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_es2c/](https://arquisoft.github.io/wichat_es2c/), we need to execute `npm run deploy`.
